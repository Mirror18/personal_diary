package com.mirror.mapper.wrapper;

import com.mirror.mapper.core.DbField;
import com.mirror.mapper.core.Criteria;
import com.mirror.mapper.core.FieldResult;
import com.mirror.mapper.core.PageInfo;
...
public class MyBatisWrapper<T> {
    public MyBatisWrapper() {
        this.coredCriteria = new ArrayList<>();
    }
    ...
    //查询条件
    protected List<Criteria<T>> coredCriteria;
    ...
    public void clear() {
        ...
        whereBuilder = null;
        updateSql = null;
        if (!CollectionUtils.isEmpty(coredCriteria)) {
            coredCriteria.clear();
        }
    }
